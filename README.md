...
<p align="center">
  <a href="https://runscars.app"><strong>Explorar Runscars →</strong></a>
  ·
...
La web pública conserva la identidad editorial validada en el prototipo y
permite recorrer:

- la [portada, el consenso y su evolución](https://runscars.app);
- la
  [temporada Oscar 2027](https://runscars.app/temporadas/2027);
- el
  [consenso de Mejor película](https://runscars.app/temporadas/2027/mejor-pelicula);
- una
  [ficha de película](https://runscars.app/peliculas/the-odyssey);
- una
  [ficha de persona](https://runscars.app/personas/tmdb-30614);
- el
  [índice de fuentes y trazabilidad](https://runscars.app/fuentes);
- los [créditos y atribución de TMDB](https://runscars.app/creditos).
