        ...
        <div className="page-shell">
          ...
          <div className="source-title-row">
            ...
            <div>
              ...
              <h1>Awards<em>Watch</em></h1>
              <p>
                Rankings y análisis firmados sobre la temporada de premios.
                Esta captura aporta una lista ordenada y un bloque no ordenado.
              </p>
            </div>
            <a className="primary-button" href={sourceUrl} rel="noreferrer" target="_blank">
      ...
      <section className="page-shell source-page-layout">
        <div className="source-main">
          <div className="source-capture-header">
            <div>
              ...
              <p>“The Awards Alchemist Looks to the Aegean Sea for Oscar Clarity”</p>
            </div>
            ...
            <ol className="source-ranking">
              {awardsWatchRanking.map((title, index) => (
                <li key={title}>
                  ...
                  {title === "The Odyssey" ? (
                    <Link href="/peliculas/the-odyssey">{title}</Link>
                  ) : (
                    <strong>{title}</strong>
                  )}
                  <span className="original-value">Valor original: {title}</span>
                </li>
              ))}
            </ol>
          </div>
          ...
          <div className="radar-section">
            ...
            <div className="radar-tags">
              {awardsWatchRadar.map((title) => <span key={title}>{title}</span>)}
            </div>
          </div>
        </div>
        ...
        <aside className="source-sidebar">
          <div className="sidebar-card source-health">
            ...
            <dl>
              <div><dt>Estado editorial</dt><dd>Seleccionada</dd></div>
              <div><dt>Estado técnico</dt><dd>Prototipo</dd></div>
              <div><dt>Publicación</dt><dd>Revisar antes</dd></div>
              <div><dt>Frecuencia</dt><dd>Mensual / semanal</dd></div>
              <div><dt>Paywall</dt><dd>Parcial</dd></div>
            </dl>
          </div>
          ...
          <div className="sidebar-card methodology-card">
            ...
            <Link href="/temporadas/2027/mejor-pelicula">Ver su efecto en el consenso →</Link>
          </div>
          ...
          <div className="sidebar-card stale-card">
            ...
            <div>
              ...
              <p>9 días desde la publicación del fixture. El aviso se activa a los 45.</p>
            </div>
          </div>
        </aside>
      </section>
