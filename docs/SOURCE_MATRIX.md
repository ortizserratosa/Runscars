...
| `rotten-tomatoes` | Rotten Tomatoes | score, review | Agregado y enlaces de crítica; discovery | Continua | Manual; estudiar licencia antes de automatizar | Parcial | selected | manual | replace-before-publish | Sí | Porcentaje de aprobación, no nota media individual; solo descubre la pieza original |
| `metacritic` | Metacritic | score, review | Agregado ponderado y enlaces de crítica; discovery | Continua | Manual; sin API pública documentada | Parcial | selected | manual | replace-before-publish | Sí | Algoritmo ponderado opaco; riesgo de doble conteo |
| `filmaffinity` | FilmAffinity | review | Listado de críticas profesionales; discovery | Continua | Manual; estudiar licencia antes de automatizar | Parcial | selected | manual | replace-before-publish | Sí | No se usa la valoración comunitaria como recepción profesional |
...
| `filmaffinity` | [Críticas profesionales de El triángulo de la tristeza](https://www.filmaffinity.com/es/pro-reviews.php?movie-id=968107) | [Últimas críticas publicadas](https://www.filmaffinity.com/es/latestreviews.php) |
