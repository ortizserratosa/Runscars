      ...
      <section className="season-hero">
        <div className="page-shell">
          ...
          <div className="season-title-row">
            ...
            <div
              className="season-stamp"
              aria-label="Temporada activa con fixture"
            >
              <span>Estado</span>
              <strong>ACTIVA · FIXTURE</strong>
          ...
          <div className="category-grid">
            {categories.map((category, index) => {
              ...
              return category.featured ? (
                ...
                <article
                  className="category-card muted-category"
                  key={category.name}
                >
                  {content}
                </article>
        ...
        <aside className="season-sidebar">
          ...
          <div className="sidebar-card source-status-card">
            ...
            <div className="status-row">
              <span>
                <i className="status-dot green" /> 4 en este consenso
              </span>
              <span>
                <i className="status-dot amber" /> 24 en otras funciones u
                oleadas
              </span>
            </div>
