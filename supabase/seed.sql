...
values
  ...
  ('obsession', 'Obsession', '{}', 2026, 'released', null, 'https://www.themoviedb.org/movie/1339713', 'La referencia editorial conserva la correspondencia verificada con el estreno de 2026'),
...
values
  ...
  ('filmaffinity', 'FilmAffinity', array['review'], 'https://www.filmaffinity.com/', 'paused', 'manual', 'review-before-publish', '2026-08-26'),
